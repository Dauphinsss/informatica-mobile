    ...
    <View style={styles.container}>
      ...
      <ScrollView style={styles.content}>
        ...
        <Card style={styles.infoCard}>
          <Card.Content>
            <Text variant="headlineMedium" style={styles.subjectTitle}>
              {subject.name}
            </Text>
            ...
            filteredMaterials.map((material, index) => (
              <View key={material.id}>
                <List.Item
                  ...
                  description={`${getTypeLabel(material.type)} • ${
                    material.size
                  } • ${material.downloadCount} descargas\nSubido por ${
                    material.uploadedBy
                  } • ${material.uploadDate}`}
                  left={(props) => (
                    <List.Icon
      ...
      <FAB
        ...
        style={styles.fab}
        onPress={() =>
          Alert.alert("Próximamente", "Función para subir materiales")
        }
      />
    </View>
  );
